...
# 推送到GitHub
export SHELL=/data/data/com.termux/files/usr/bin/bash PREFIX=/data/data/com.termux/files/usr LD_PRELOAD=/data/data/com.termux/files/usr/lib/libtermux-exec.so TMPDIR=/data/data/com.termux/files/usr/tmp SHLVL=1 LD_LIBRARY_PATH=/data/data/com.termux/files/usr/lib PATH=:/data/data/com.termux/files/usr/bin:/data/data/com.termux/files/usr/bin/applets;git add /sdcard/ADM/Github/Ad-set-hosts/* && git commit -m "`date '+%Y-%m-%d %T'`" && git push -u origin master && echo " `date '+%Y-%m-%d %T' `更新hosts成功"
